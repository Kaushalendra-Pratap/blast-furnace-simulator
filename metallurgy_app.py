...
# Swapped to INR Values
ore_price = st.sidebar.number_input("Ore Price (₹/Ton)", value=8500)
flux_price = st.sidebar.number_input("Flux Price (₹/Ton)", value=1500)
...
c4.metric("Cost / Ton Fe", f"₹{round(total_cost/target_iron, 2)}") # Swapped to ₹
